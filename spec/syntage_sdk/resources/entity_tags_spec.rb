...
RSpec.describe SyntageSdk::Resources::EntityTags do
  ...
  describe '#create' do
    it 'posts to the entity-tags path' do
      ...
      expect(client).to have_received(:post).with('entity-tags', anything)
    end
    ...
    it 'sends entityId in the body' do
      ...
      expect(client).to have_received(:post)
        .with(anything, body: hash_including(entityId: 'ent_123'))
    end
    ...
    it 'sends name in the body' do
      ...
      expect(client).to have_received(:post)
        .with(anything, body: hash_including(name: 'vip'))
    end
  ...
  describe '#update' do
    it 'patches the entity-tags path with the given id' do
      ...
      expect(client).to have_received(:patch).with('entity-tags/etag_123', anything)
    end
    ...
    it 'sends name in the body' do
      ...
      expect(client).to have_received(:patch)
        .with(anything, body: hash_including(name: 'premium'))
    end
